...
#include "Sandbox/DemoScenes/DemoCube.hpp"
...
int main(int argc, const char** argv) {
    ...
    const char* demos[] = { "None", "Clear color", "Triangle", "Texture 2D", "Rainbow Triangle", "Cube" };
